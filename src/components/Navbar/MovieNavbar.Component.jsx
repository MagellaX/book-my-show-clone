...
/**
 * Responsive navigation bar for movie-related content.
...
const MovieNavbar = () => {
    ...
    /**
     * Small screen navigation component. 
     *Displays only the movie title and share icon.
     */
    const NavSm = () => (
    ...
    /**
     * Large screen navigation component.
     * Includes movie logo, search bar, location selector, sign in button, and menu icon...
     */
    const NavLg = () => (
    ...
    return (
        <nav className="bg-white border-b-2 lg:border-b-0 lg:bg-darkBackground-700 p-4">
            ...
            {/* Render NavSm for mobile screens and NavLg for larger screens */}
